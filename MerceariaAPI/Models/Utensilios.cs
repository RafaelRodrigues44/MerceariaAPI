...
namespace MerceariaAPI.Models
{
    public class Utensilios : Produto
    {
        ...
        public Utensilios(int id, string nome, decimal preco, int estoque, DateTime dataFabricacao, DateTime dataValidade, string lote, string fornecedor, string descricao, string tipo)
